...
router.post("/", (req, res) => {
    // Push a new user object into the users array base on query parameters from the request
    users.push({
    ...
    // Send a succes message as the response, indicating the user has been added
...
router.put("/:email", (req, res) => {
    ...
    if (filtered_users.length < 0) {
        ...
        // Send succes message indicating the user has been updated
...
router.delete("/:email", (req, res) => {
    ...
    users = users.filter((user) => user.email != email);
    // Send a succes message as the response, indicating the user has been deleted
